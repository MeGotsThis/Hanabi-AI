...
class Game13382(GameSimulatorTesting):
    ...
    def test_turn_19(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=19, botcls=Bot)
        self.send_action()
    ...
    def test_turn_23(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=23, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(0)

    def test_turn_25(self):
        # Deck size 26, Bob, Clues 2, Score 9
        self.load_game(r'games\13382.json', position=1, turn=25, botcls=Bot)
        self.send_action()
        self.connection.assert_card_discarded_hand(2)

    def test_turn_27(self):
        # Deck size 25, Bob, Clues 2, Score 9
        self.load_game(r'games\13382.json', position=1, turn=27, botcls=Bot)
        self.send_action()
        #self.connection.assert_card_discarded_hand(4)
        self.connection.assert_card_played_hand(3)

    def test_turn_29(self):
        # Deck size 23, Bob, Clues 3, Score 10
        self.load_game(r'games\13382.json', position=1, turn=29, botcls=Bot)
        self.send_action()
    ...
    def test_turn_31(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=31, botcls=Bot)
        self.send_action()
    ...
    def test_turn_33(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=33, botcls=Bot)
        self.send_action()
        #self.connection.assert_card_discarded_hand(4)
        self.connection.assert_card_played_hand(3)

    def test_turn_35(self):
        # Deck size 21, Bob, Clues 0, Score 11
        self.load_game(r'games\13382.json', position=1, turn=35, botcls=Bot)
        self.send_action()
    ...
    def test_turn_39(self):
        # Deck size 18, Bob, Clues 0, Score 12
        self.load_game(r'games\13382.json', position=1, turn=39, botcls=Bot)
        self.send_action()
        #self.connection.assert_card_discarded_hand(4)
        self.connection.assert_card_played_hand(2)
    ...
    def test_turn_41(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=41, botcls=Bot)
        self.send_action()
        #self.connection.assert_card_discarded_hand(4)
        self.connection.assert_card_played_hand(2)

    def test_turn_43(self):
        # Deck size 15, Bob, Clues 2, Score 12
        self.load_game(r'games\13382.json', position=1, turn=43, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(2)

    def test_turn_45(self):
        # Deck size 13, Bob, Clues 3, Score 13
        self.load_game(r'games\13382.json', position=1, turn=45, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(1)

    def test_turn_47(self):
        # Deck size 11, Bob, Clues 4, Score 14
        self.load_game(r'games\13382.json', position=1, turn=47, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(0)

    def test_turn_49(self):
        # Deck size 10, Bob, Clues 3, Score 15
        self.load_game(r'games\13382.json', position=1, turn=49, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(4)

    def test_turn_51(self):
        # Deck size 9, Bob, Clues 2, Score 16
        self.load_game(r'games\13382.json', position=1, turn=51, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(4)

    def test_turn_53(self):
        # Deck size 8, Bob, Clues 1, Score 17
        self.load_game(r'games\13382.json', position=1, turn=53, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(4)
    ...
    def test_turn_57(self):
        ...
        self.load_game(r'games\13382.json', position=1, turn=57, botcls=Bot)
        self.send_action()
        self.connection.assert_card_discarded_hand(1)

    def test_turn_59(self):
        # Deck size 3, Bob, Clues 2, Score 19
        self.load_game(r'games\13382.json', position=1, turn=59, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(0)

    def test_turn_61(self):
        # Deck size 2, Bob, Clues 2, Score 20
        self.load_game(r'games\13382.json', position=1, turn=61, botcls=Bot)
        self.send_action()
        self.connection.assert_card_played_hand(3)
